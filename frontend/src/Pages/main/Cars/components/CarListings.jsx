...
import { CarListingsLoading } from './CarListingsLoadings'
...
export function CarListings() {
    ...
    const { loading, getCars: getCars, data: result, error } = useFetch();
    ...
    }, [currentPage, navigate, searchParams, page]);
        ...
        return (
            <div className="min-h-[400px] flex flex-col items-center justify-center text-center p-8 border rounded-lg bg-gray-50">
                ...
                <Button variant="outline" asChild>
                    <Link to="/cars">Clear all filters</Link>
                </Button>
            </div>
        );
    }
